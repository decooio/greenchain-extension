...
export const BG_APP_GET_LANGUAGE = 'APP/GET_LANGUAGE';
export const BG_APP_SET_LANGUAGE = 'APP/SET_LANGUAGE';
export const BG_SET_HASH_KEY = 'APP/SET_HASH_KEY';
export const BG_CLEAR_HASH_KEY = 'APP/CLEAR_HASH_KEY';
...
export const BG_ACCOUNTS_EXPORT = 'ACCOUNTS/EXPORT';
export const BG_ACCOUNTS_CREATE_ACCOUNT_WITH_JSON = 'ACCOUNTS/CREATE_ACCOUNT_WITH_JSON';
export const BG_ACCOUNTS_VERIFY_PASSWORD = 'ACCOUNTS/VERIFY_PASSWORD';
...
export const BG_NETWORK_GET_DECIMALS = 'NETWORK/DECIMALS';
export const BG_NETWORK_FORCE_CONNECT = 'NETWORK/FORCE_CONNECT';
export const BG_NETWORK_DIS_CONNECT = 'NETWORK/DIS_CONNECT';
// Address Book
...
export const BG_DAPP_GET_METADATA_LIST = 'DAPP/GET_METADATA_LIST';
export const BG_DAPP_METADATA_PROVIDE = 'DAPP/METADATA_PROVIDE';
export const BG_DAPP_ALLOW_METADATA_PROVIDE = 'DAPP/ALLOW_METADATA_PROVIDE';

// Contract
export const BG_CONTRACT_ADD = 'CONTRACT/ADD';
export const BG_CONTRACT_GET_TOKEN_LIST = 'CONTRACT/GET_TOKEN_LIST';
export const BG_CONTRACT_UPDATE_TOKEN_BALANCES = 'CONTRACT/UPDATE_TOKEN_BALANCES';

// Token
export const BG_GREENCHAIN_GET_TOKEN_LIST = 'GREENCHAIN/GET_TOKEN_LIST';
export const BG_GREENCHAIN_UPDATE_CANDY_BALANCE = 'GREENCHAIN/UPDATE_CANDY_BALANCE';
